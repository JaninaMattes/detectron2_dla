...
def parse_opt(known=False):
    ...
    parser.add_argument('--config_file', type=str, default='configs/DLA_mask_rcnn_R_101_FPN_3x.yaml', help='initial config file path')
    parser.add_argument('--opt', type=str, default='configs/DLA_mask_rcnn_R_101_FPN_3x.yaml', help='initial config file path')
    opt = parser.parse_known_args()[0] if known else parser.parse_args()
    return opt

def main(args, pretrained_model_pth="pretrained_models/Resnet-101/model_final.pth"):
